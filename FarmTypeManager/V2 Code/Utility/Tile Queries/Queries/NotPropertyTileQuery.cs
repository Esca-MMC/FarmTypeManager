...
{
    /// <summary>A handler for the "!PROPERTY" tile query. Allows tiles that do NOT have the specified tile property and optional value(s).</summary>
    /// <remarks>Expected string format: "!PROPERTY {Layer} {Property} [List of values]". Example: "!PROPERTY Back Diggable T True".</remarks>
    public class NotPropertyTileQuery : ITileQuery
    {
        /***************/
        /* Constructor */
        /***************/
        ...
        public NotPropertyTileQuery(GameLocation location, string[] queryArgs)
        {
            Location = location;
        ...
        /// <summary>A set of invalid property values. Case-insensitive. Null if all values are invalid.</summary>
        ...
        public bool CheckTile(Vector2 tile) => !(Location.doesTileHaveProperty((int)tile.X, (int)tile.Y, PropertyKey, Layer) is string propertyValue && (PropertyValues == null || PropertyValues.Contains(propertyValue))); //tile does not have the property or, if specified, its value doesn't match
