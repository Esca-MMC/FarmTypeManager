...
{
    /// <summary>A handler for the "!HAS_CHARACTER" tile query. Allows tiles that do NOT contain any characters (farmers, NPCs, animals, etc).</summary>
    public class NotHasCharacterTileQuery : ITileQuery
    {
        /***************/
        /* Constructor */
        /***************/
        ...
        public NotHasCharacterTileQuery(GameLocation location)
        {
            Location = location;
        }
