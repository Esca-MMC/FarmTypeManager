...
{
    /// <summary>A handler for the "!HAS_RESOURCE_CLUMP" tile query. Allows tiles that do NOT intersect any resource clump (see <see cref="GameLocation.largeTerrainFeatures"/>). Notably includes giant crops.</summary>
    public class NotHasResourceClumpTileQuery : ITileQuery
    {
        /***************/
        /* Constructor */
        /***************/
        ...
        public NotHasResourceClumpTileQuery(GameLocation location)
        {
            Location = location;
        }
