...
{
    /// <summary>A handler for the "HAS_LARGE_TERRAIN_FEATURE" tile query. Allows tiles that intersect at least one large terrain feature (see <see cref="GameLocation.largeTerrainFeatures"/>).</summary>
    public class HasLargeTerrainFeatureTileQuery : ITileQuery
    {
        /***************/
        /* Constructor */
        /***************/
        ...
        public HasLargeTerrainFeatureTileQuery(GameLocation location)
        {
            Location = location;
        }
