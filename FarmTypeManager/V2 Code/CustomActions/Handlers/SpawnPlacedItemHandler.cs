...
{
    /// <summary>The handler for a custom action that spawns an item placed on the ground. Similar to <see cref="SpawnObjectHandler"/>, but implements support for more <see cref="Item"/> types and features.</summary>
