...
namespace FarmTypeManager.CustomActions
{
    ...
    public interface ICustomActionHandler
    {
        ...
        /// <remarks>This should generally be a custom class with fields used by a specific action type. Vague field types like 'object' might limit Content Patcher's ability to add or edit settings.</remarks>
        Type SettingsType { get; }

        /// <summary>Try to perform the specified custom action with the given ID and settings.</summary>
        /// <param name="actionType">The custom action to perform.</param>
        ...
        bool TryPerform(string actionType, object rawSettings, GameStateQueryContext queryContext, TriggerActionContext triggerContext, out string error);
    }
}
