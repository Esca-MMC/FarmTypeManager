...
namespace FarmTypeManager.ExternalFeatures.GameStateQueries
{
    ...
    public class GSQ_LocationExists
    {
        ...
        public static void Enable(IModHelper helper)
        {
            ...
            GameStateQuery.Register(prefix + "LOCATION_EXISTS", GSQ_LocationExists_Impl);

            Enabled = true;
        }

        /// <summary>Checks whether the given name matches an existing, loaded location.</summary>
        ...
        /// <returns>Returns true if a location in "Utility.ForEachLocation" has a matching name (NameOrUniqueName).</returns>
        /// <remarks>
        /// Format: Esca.FarmTypeManager_LOCATION_EXISTS &lt;location&gt;
        /// <br/><br/>
        /// The location argument does NOT support the special values used by base game GSQs, e.g. "Here" and "Target".
        /// </remarks>
        private static bool GSQ_LocationExists_Impl(string[] query, GameStateQueryContext context)
        {
