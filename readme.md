...
SpawnWeight | An integer (minimum/default 1) | The weighted spawn chance of this forage type. | Increasing this will incease the odds of spawning this forage type instead of others, similar to adding multiple copies of it to a forage list. Has no effect in "loot" or "contents" lists. Example: If this forage type's weight is 5 and another type's weight is 1, this type will spawn 5 times as often.
...
SpawnWeight | An integer (minimum/default 1) | The weighted spawn chance of this monster type. | Increasing this will incease the odds of spawning this monster type instead of others, similar to adding multiple copies of it to the list. Example: If this monster type's weight is 5 and another type's weight is 1, this type will spawn 5 times as often.
