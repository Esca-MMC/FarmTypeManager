...
Seasons | A list of season names or "Any"/"All" | A list of seasons in which forage is allowed to spawn. | Seasons should be inside the brackets with quotation marks, separated by commas if multiple are listed. Stardew recognizes these names: "Spring", "Summer", "Fall", and "Winter". See these examples: `["Spring"]`, `["Summer", "Winter"]`
...
Seasons | A list of season names or "Any"/"All" | A list of seasons in which large objects are allowed to spawn. | Seasons should be inside the brackets with quotation marks, separated by commas if multiple are listed. Stardew recognizes these names: "Spring", "Summer", "Fall", and "Winter". See these examples: `["Spring"]`, `["Summer", "Winter"]`
...
Years | A list of integers, ranges, or "Any"/"All" | A list of years in which ore is allowed to spawn. | Years should be inside the brackets with quotation marks, separated by commas if multiple are listed. They can be listed as single years, ranges, or with a **+** to include any following years. See these examples: `["1"]` `["2-4"]` `["1", "3+"]`
Seasons | A list of season names or "Any"/"All" | A list of seasons in which ore is allowed to spawn. | Seasons should be inside the brackets with quotation marks, separated by commas if multiple are listed. Stardew recognizes these names: "Spring", "Summer", "Fall", and "Winter". See these examples: `["Spring"]`, `["Summer", "Winter"]`
